...
export const STANDARD_ISL_ANIMATIONS: Record<string, ISLAnimationDefinition> = {
  ...
  "HOW": { type: "interlockRotate", duration: 1.0, handShape: "interlock", twoHanded: true, description: "Interlocked fingers rotating" },
  "WHO": { type: "pointThumbOver", duration: 0.8, handShape: "thumbUp", description: "Pointing thumb over shoulder" },
  "WHICH": { type: "alternatePoint", duration: 1.0, handShape: "index", description: "Alternating pointing between options" },
  ...
  "6": { type: "number6", duration: 0.5, handShape: "thumbPinky", description: "Six - thumb and pinky" },
  "7": { type: "number7", duration: 0.5, handShape: "thumbIndex", description: "Seven - thumb and index" },
  "8": { type: "number8", duration: 0.5, handShape: "thumbMiddle", description: "Eight - thumb and middle" },
  "9": { type: "number9", duration: 0.5, handShape: "curled", description: "Nine - curled index" },
  "10": { type: "number10", duration: 0.5, handShape: "shake", description: "Ten - shake L shape" },
  ...
  "ANGRY": { type: "angryClaw", duration: 0.9, handShape: "claw", description: "Claw hand shake" },
